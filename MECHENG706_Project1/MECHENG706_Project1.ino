...
STATE running() {
  ...
  //    ultra = HC_SR04_range();
  //    BL_IR(backL);
  //    float ultraprint=Ultra_Data[0]-5.64;
  //    BluetoothSerial.println((String)"ultra reading is" + ultraprint);
  //    BluetoothSerial.println((String)"IR left is:" + backL[0]);
  //    delay(200);
  //  }
  //
  //ServoFaceRight();
